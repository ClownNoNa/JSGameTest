window.addEventListener('load',function(){
    ...
    class InputHandler{
        constructor(){
            ...
            window.addEventListener('keydown',e => {
                ...
                }else if (e.key === 'Enter' && gameOver) gameRestart();
            });
            ...
            window.addEventListener('touchmove', e => {
                ...
                else if (swipeDistance > this.touchTreshold && this.keys.indexOf('swipe down') === -1) this.keys.push('swipe down' === -1)
            });
    ...
    function toggleFuffScreen(){
        console.log(document.fullscreenElement);
        if(!document.fullscreenElement){
            canvas.requestFullscreen().then().catch(err =>{
                alert('Errer, can not enable full-screen mode: ${err.message}');
            });
        }else{
            document.exitFullscreen();
        }
    }
    fullScreenButton.addEventListener('click',toggleFuffScreen);
